...
import com.xsdlr.rnjmessage.im.adapter.AlbumListAdapter;
import com.xsdlr.rnjmessage.im.entity.ImageBean;
import com.xsdlr.rnjmessage.im.tools.SortPictureList;
...
//		mGroupGridView = (GridView) findViewById(R.id.pick_picture_total_grid_view);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				startActivityForResult(mIntent, Contracts.REQUEST_CODE_SELECT_ALBUM);
...
//        Collections.sort(list, sortComparator);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == Contracts.RESULT_CODE_SELECT_ALBUM) {
			setResult(Contracts.RESULT_CODE_SELECT_PICTURE, data);
			finish();
		}
	}
