...
//                    startActivityForResult(intent, Contracts.REQUEST_CODE_CROP_PICTURE);
                }
            }
        } else if (requestCode == Contracts.REQUEST_CODE_SELECT_PICTURE) {
            if (data != null) {
        ...
        } else if (requestCode == Contracts.REQUEST_CODE_CROP_PICTURE) {
//            mMainController.uploadUserAvatar(mUri.getPath());
            String path = data.getStringExtra("filePath");
            if (path != null) {
                mMainController.uploadUserAvatar(path);
            }
        } else if (resultCode == Contracts.RESULT_CODE_ME_INFO) {
...
//                Intent intent = new Intent();
//                intent.putExtra("filePath", mUri.getPath());
//                intent.setClass(ChanMainActivity.this, CropImageActivity.class);
//                startActivityForResult(intent, Contracts.REQUEST_CODE_CROP_PICTURE);
            }
        });
    }
