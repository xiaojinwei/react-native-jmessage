...
public class PickPictureAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.mImageView = (SimpleDraweeView) convertView.findViewById(R.id.child_image);
...
//            mImageView.setImageBitmap(bitmap);
//        } else {
//            mImageView.setImageResource(R.drawable.jmui_picture_not_found);
//        }
            ImageRequest request = ImageRequestBuilder.newBuilderWithSource(FrescoImageUtil.getUriFromFile(path))
