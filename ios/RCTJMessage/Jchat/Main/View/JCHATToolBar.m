...
- (void)drawRect:(CGRect)rect {
  ...
  self.startRecordButton.titleLabel.font=[UIFont systemFontOfSize:15];
  [self.startRecordButton setTitleColor:UIColorFromRGB(0x9c9c9c) forState:UIControlStateNormal];
  [self.startRecordButton setTitleColor:UIColorFromRGB(0x9c9c9c) forState:UIControlStateHighlighted];
  ...
  [self.startRecordButton setBackgroundColor:UIColorFromRGB(0xffffff)];
    self.startRecordButton.layer.cornerRadius=5.0;
